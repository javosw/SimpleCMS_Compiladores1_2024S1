...
public enum Indicador
{
    ...
    // sqcms
    SQ_CONSULT, PUNCOM, COMA, DOT, 
    SQ_SITE_VIEWS, SQ_PAGE_VIEWS, SQ_PAGE_POP,
    SQ_TODOS, SQ_TITULO, SQ_MENU, SQ_IMAGEN, SQ_VIDEO, SQ_PARRAFO,
    SQ_ARG_PATHS, SQ_ARG_PATH, SQ_ARG_SITES, SQ_ARG_SITE,
    ;
}
